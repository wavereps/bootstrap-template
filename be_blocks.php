...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <a class="block block-link-rotate" href="javascript:void(0)">
                <div class="block-header">
                    <h3 class="block-title">Title</h3>
                </div>
                <div class="block-content">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        ...
                        <button type="button" class="btn-block-option" data-toggle="tooltip" title="Undo">
                            <i class="si si-action-undo"></i>
                        </button>
                        <button type="button" class="btn-block-option" data-toggle="tooltip" title="Redo">
            ...
            <div class="block">
                <div class="block-header block-header-default block-header-rtl">
                    ...
                    <div class="block-options">
                        ...
                        <button type="button" class="btn-block-option" data-toggle="tooltip" title="Profile">
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="be_blocks.php" method="post">
                <div class="block">
                    <div class="block-header block-header-default">
                    ...
                    <div class="block-content">
                        <div class="form-group row justify-content-center">
                            <label class="col-sm-8" for="block-form-username">Username</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="block-form-username" name="block-form-username" placeholder="Enter your username..">
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            <label class="col-sm-8" for="block-form-password">Password</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-8">
                                <label class="css-control css-control-sm css-control-primary css-switch">
                                    <input type="checkbox" class="css-control-input" id="block-form-remember-me" name="block-form-remember-me">
        ...
        <div class="col-md-6">
            <form action="be_blocks.php" method="post">
                <div class="block">
                    ...
                    <div class="block-content">
                        <div class="form-group row justify-content-center">
                            <label class="col-sm-8" for="block-form-username2">Username</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="block-form-username2" name="block-form-username2" placeholder="Enter your username..">
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            <label class="col-sm-8" for="block-form-password2">Password</label>
                            <div class="col-sm-8">
                                <input type="password" class="form-control" id="block-form-password2" name="block-form-password2" placeholder="Enter your password..">
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-8">
                                <label class="css-control css-control-sm css-control-primary css-switch">
                                    <input type="checkbox" class="css-control-input" id="block-form-remember-me2" name="block-form-remember-me2">
                                    <span class="css-control-indicator"></span> Remember Me?
                                </label>
                            </div>
                        </div>
